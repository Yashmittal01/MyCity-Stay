...
const { index, newListing, saveNewListing, indivisualListing, editListing, saveEditListing, deleteListing, filter } = require("../controllers/listing.js");
...
//show route
router.get("/:id",wrapAsync(indivisualListing));
